<div class="list-group">
    <?php 
        foreach($datos as $ver){
            ...
            if($ver['estado_asignacion'] == 0){
                ?>
                <a href="../editar_asignacion.php?id_asignacion=<?= $ver['id_asignacion_tarea']?>" class="list-group-item list-group-item-action list-group-item-warning mb-3" aria-current="true">
